...
def run(args, server):
  ...
  with sv.managed_session(
      server.target, config=config) as sess, sess.as_default():
...
"""
  ...
  parser.add_argument(
      '--log-dir', default="/tmp/pong", help='Log directory path')
  parser.add_argument(
      '--env-id', default="PongDeterministic-v3", help='Environment id')
  parser.add_argument(
      '-r',
      '--remotes',
      default=None,
